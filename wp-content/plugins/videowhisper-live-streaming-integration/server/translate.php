...
$options = get_option( 'VWliveStreamingOptions' );
			...
			if ( $options['corsACLO'] ) {
				...
				$http_origin = esc_url( $http_origin );
...
$VideoWhisper = isset($_POST['VideoWhisper']) && is_array($_POST['VideoWhisper']) ? $_POST['VideoWhisper'] : []; // array elements sanitized individually
