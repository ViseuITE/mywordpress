...
<div class="flex content-around w-auto bg-orange-400 m-0 p-0">
    <video class="text-center items-center flex w-1/5 h-28 object-cover box-radius" autoplay muted loop>
      <source
  ...
  <header class=" w-4/5">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                <ul class="flex flex-wrap items-center font-medium text-sm">
                  ...
                  <li class="">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">ODD RATE</a>
                  </li>
                  <li class="">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">SCHEDULES</a>
                  </li>
                  <li class="">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">RESULT</a>
                  </li>
                  <li class="">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">ROOM CHAT</a>
                  </li>
                  <li class="">
    ...
    <nav class="bg-gray-600 ">
      <div class="mx-auto max-w-7xlpx-2 sm:px-6 lg:px-8">
        <div class="relative flex h-14 items-center justify-between">
          <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <!-- Mobile menu button-->
            <button type="button" onclick="ToggleMenu(this)" name="menu" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <ul class="flex flex-wrap items-center font-medium text-sm">
                  ...
                  <li
                    ...
                    <a
                      class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white"
                      href="#0"
                      :aria-expanded="open">Flyout Menu</a>

                    <ul
                      class="origin-top-right px-8 absolute top-full left-1/2 -translate-x-1/2  bg-white border border-slate-200 p-2 rounded-lg shadow-xl [&[x-cloak]]:hidden"
                      x-show="open"
                      x-transition:enter="transition ease-out duration-200 transform"
                      x-transition:enter-start="opacity-0 -translate-y-2"
                      x-transition:enter-end="opacity-100 translate-y-0"
                  ...
                  <li class="">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Number</a>
                  </li>
            ...
            <div class="flex space-x-4">
              ...
              <ul class="flex flex-wrap items-center font-medium text-sm">
                ...
                <li
                  ...
                  <ul
                    class="origin-top-right px-8 absolute z-50 top-full left-1/2 -translate-x-1/2  bg-white border border-slate-200 p-2 rounded-lg shadow-xl [&[x-cloak]]:hidden"
                    x-show="open"
                    x-transition:enter="transition ease-out duration-200 transform"
                    x-transition:enter-start="opacity-0 -translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0"
